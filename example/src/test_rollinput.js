  ...
  render() {
    ...
    return (
      <Screen lines={16}
        ...
        />}
      >
        <Bar lines={2} text={<Text D3>Roll Input change value upon user clicks. It is styled to align with other input elements.</Text>} />
        <Block lines={7} style={{borderWidth:1, margin:2}}>
          ...
          />
          <DataBar
            text={(k++) + '. Basic Roll Input'}
            input={<Roll input items={this.logos}
          ...
          />
          <DataBar
            text={(k++) + '. Underlined IconOnly Roll'}
            input={<Roll input items={this.logos} iconOnly underline
              disabled={this.state.disabled}
              value={this.state.d5}
              onValueChange={(d5)=>this.setState({d5})}
            />}
          />
          <DataBar lines={1.5}
            text={(k++) + '. Underlined IconOnly Roll'}
            input={<Roll input items={this.logos} iconTop underline
              disabled={this.state.disabled}
              value={this.state.d5}
              onValueChange={(d5)=>this.setState({d5})}
            />}
        ...
        <Bar lines={2}>
          ...
          <DataBlock style={{borderWidth:1}}
            text={(k++) + '. Basic Roll Input'}
            input={<Roll input items={this.genders} iconRight
              disabled={this.state.disabled}
              value={this.state.d3}
        ...
        <Bar lines={2}>
          ...
          <DataBlock style={{borderWidth:1}}
            text={(k++) + '. Underlined Roll Input'}
            input={<Roll input items={this.genders} iconRight underline
              disabled={this.state.disabled}
              value={this.state.d4}
